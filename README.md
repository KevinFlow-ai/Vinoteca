...
---
🧩 Sección “Problemas” versión ampliada

1. Dificultad para identificar vinos cuando un cliente preguntaba
...
Un vino que antes estaba en la posición X podía aparecer al día siguiente en la posición Y.
Esto obligaba a aprender de nuevo toda la distribución, aumentando el tiempo de reposición y la frustración y con ello perdida en la productividad.

4. Problemas al revisar facturas al final de la jornada
...
5. Nombres distintos entre factura y empaque
